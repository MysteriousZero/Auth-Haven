...
const (
	SessionService_ListSessions_FullMethodName      = "/auth.SessionService/ListSessions"
	SessionService_RevokeSession_FullMethodName     = "/auth.SessionService/RevokeSession"
	SessionService_RevokeAllSessions_FullMethodName = "/auth.SessionService/RevokeAllSessions"
)
